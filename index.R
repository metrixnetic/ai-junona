...
#easter
p[[paste0(as.integer(date = "2021-08-21"))]] <- c("да", "С Пасхой")
#summer
p[[paste0(as.integer(date = "2021-06-01"))]] <- c("Превый день лета!","Школьники заполонили интернет", "Лето началось!")
#autumn
p[[paste0(as.integer(date = "2021-09-01"))]] <- c("Первый день осени","Школьники освободили интернет", "Теперь деревья голые :/")
#winter
p[[paste0(as.integer(date = "2021-11-01"))]] <- c("Первый день зимы", "А почему все белое", "Скоро новый год", "Зимааа")
#spring
p[[paste0(as.integer(date = "2021-03-01"))]] <- c("Весна", "Весна пришла", "Скоро школьники заполонят интернет")
